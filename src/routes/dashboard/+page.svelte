<script lang="ts">
	...
	import DiscordChannelsCard from '$lib/components/dashboard/DiscordChannelsCard.svelte';
</script>
...
<div class="h-full overflow-y-auto p-6">
	<div class="max-w-7xl mx-auto">
		<div class="mb-6">
			...
			<p class="text-sm text-zinc-500 mt-1">Live overview of infrastructure and agents</p>
		</div>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
			...
			<DiscordChannelsCard class="lg:col-span-2" />
		</div>
	</div>
</div>
